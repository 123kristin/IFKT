...
class GKT(Module):
    ...
    '''
    def __init__(self, num_q, hidden_size=30, num_attn_heads=2, method="PAM"):
        super().__init__()
        self.num_q = num_q
...
class GKTModule(pl.LightningModule):
    def __init__(self, n_question):
        super(GKTModule, self).__init__()
        self.loss = nn.BCEWithLogitsLoss()
        self.dkt = GKT(n_question)
