...
class MYMODEL(nn.Module):
    def __init__(self, n_question, n_qtype, max_seq, embed_dim, n_query_features, n_gcn_layers, gcn_data, dropout, new_att):
        ...
        self.n_query_features_q = n_query_features - 1
        ...
        # q拼接4个特征 e, s, qt, d
        self.combine_q_embedding_q = nn.Linear(embed_dim * (n_query_features - 1), embed_dim)
    ...
    def forward(self, x, question_ids, skill_ids, qt_ids, diff, ms_response_norm):
        ...
        # gcn_layer为0时
        # w_q, w_s = self.gcn.get_embeddings(question_ids, skill_ids)
        ...
        combine_embed_x = torch.cat((x, ms), dim=2)
